...
\begin{frame}
    ...
    \begin{figure}[!htbp]
       	...
       	\includegraphics[scale=0.3]{recursos/exemplos/exemploFigura}
...
\begin{frame}
    ...
    \begin{quadro}[!htbp]
       	...
       	\includegraphics[scale=.3]{recursos/exemplos/exemploQuadro}
        \\ \vspace{0.2cm}
       	\small{\textbf{Fonte:} Elaborada pelo autor (fonte é opcional)}%
    \end{quadro}
...
\begin{frame}
    ...
    Todas as macros que você utilizou na elaboração do seu documento podem ser usadas nas apresentações, com exceção do ambiente verbatim. Você poderá criar citações formatadas também e as referências serão geradas em um slide à parte, sem numeração e estilo, que ficará no fim do PDF. Por exemplo:
