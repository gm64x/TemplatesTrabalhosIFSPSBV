	...
	\textbf{Obs:} Para facilitar, crie o cronograma usando o modelo do Word contido no projeto em \path{recursos/exemplos/templateCronograma.docx}, ou qualquer outro \textit{software}, salve a imagem e atualize \path{recursos/exemplos/cronograma.png}.
